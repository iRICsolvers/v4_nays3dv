...
!
                        a_p(i,j,k)=a_n(i,j,k)+a_s(i,j,k)+a_w(i,j,k)+a_e(i,j,k)+a_u(i,j,k)+a_d(i,j,k)
                ...
                do j=1,ny
                    do k=1,nz
                        if(obst3d(i,j,k)==0) then
                            ...
                            if(k>1.and.obst3d(i,j,k-1)==1) then
                                ypn(i,j,k-1)=ypn(i,j,k)-rho*g*hs(i,j)*(-(yc(i,j,k)-c0))*dz(k)
                            end if
                            if(k<nz.and.obst3d(i,j,k+1)==1) then
                                ypn(i,j,k+1)=ypn(i,j,k)+rho*g*hs(i,j)*(-(yc(i,j,k)-c0))*dz(k)
                            end if
                        end if
                    end do
    ...
    !*******************************
        ...
        do i=0,nx
            ...
            do j=1,ny
                ...
                qu(i,j)=0.
                do k=1,nz
                    if(obst3d(i,j,k)==0.and.obst3d(i+1,j,k)==0) then
